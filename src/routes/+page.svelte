<div class="relative bg-gray-50 pt-5 sm:pt-10">
                ...
                <div class="text-center xl:col-span-2 lg:text-left md:px-16 lg:px-0">
                    <div class="max-w-sm mx-auto sm:max-w-md md:max-w-full">
                        ...
                        <div class="mt-8 lg:mt-12 lg:flex lg:items-center">
                            ...
                            <p class="mt-4 text-lg text-gray-900 lg:mt-0 lg:ml-4 font-pj">Join with <span class="font-bold">4600+ Users</span> and start saving <span class="text-3xl font-bold text-emerald-400 ">95% </span>time.</p>
                        </div>
                    </div>
