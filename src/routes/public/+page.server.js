{/* <div class=" w-full h-full pt-20 sm:pt-24">
	...
	<div class="max-w-5xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
		...
		<div class="mb-4 px-3 py-1 flex flex-row">
			<div class="w-full mr-5">
				<label class="block text-gray-700 font-bold mb-2" for="name"> City </label>
				<input
			...
			<div class="w-full mr-5">
				<label class="block text-gray-700 font-bold mb-2" for="name"> State </label>
				<input
			...
			<div class="w-full">
				<label class="block text-gray-700 font-bold mb-2" for="name"> pincode </label>
				<input
		...
		<div class="mb-4 px-3 py-1">
			<label class="block text-gray-700 font-bold mb-2" for="email"> Linkedin Username </label>
			<input
		...
		<div class="mb-4 px-3 py-1">
			<label class="block text-gray-700 font-bold mb-2" for="email"> Github Username </label>
			<input
	...
	<div class="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
		...
		{#each education as item, index}
			{#if item.vis}
				<div in:slide={{ duration: 600, axis: 'y' }} out:slide={{ duration: 800, axis: 'y' }}>
					<div class="mb-4 px-3 py-1">
					...
					<div class="mb-4 px-3 py-1 flex flex-row">
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="service"> End Month </label>
							<select
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="edmonth{index}"
								name="edmonth{index}"
						...
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="service"> End Year </label>
							<input
								bind:value={item.endYear}
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="name"
								type="number"
								placeholder="Enter year of Completetion"
							/>
						</div>
					</div>
					<div class="mb-4 px-3 py-1 flex flex-row">
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="service"> Grade Title </label>
							<select
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="gradeTitle"
								name="gradeTitle"
						...
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="service"> Grades </label>
							<input
	...
	<div class="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
		...
		{#each experience as item, index}
			<div in:slide={{ duration: 600, axis: 'y' }} out:slide={{ duration: 800, axis: 'y' }}>
				<div class="mb-4 px-3 py-1">
					<div class="w-full">
						<button on:click={() => deleteExp(index)}>Delete</button>
					</div>
				...
				<div class="mb-4 px-3 py-1">
					<label class="block text-gray-700 font-bold mb-2" for="name"> Designation </label>
					<input
				...
				<div class="mb-4 px-3 py-1 flex flex-row">
					<div class="w-full mr-5">
						<label class="block text-gray-700 font-bold mb-2" for="name"> Start Month </label>
						<select
							class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
							id="startMonth{index}"
					...
					<div class="w-full mr-5">
						<label class="block text-gray-700 font-bold mb-2" for="name"> Start Year </label>
						<input
				...
				<div class="mb-4 px-3 py-1 flex flex-row">
					<div class="w-full mr-5">
						<label class="block text-gray-700 font-bold mb-2" for="name"> End Month </label>
						<select
							class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
							id="startMonth{index}"
							name="startMonth{index}"
					...
					<div class="w-full mr-5">
						<label class="block text-gray-700 font-bold mb-2" for="name"> End Year </label>
						<input
							bind:value={item.endYear}
							class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
							id="endYear{index}"
				...
				<div class="mb-4 px-3 py-1 flex flex-row">
					<div class="w-full mr-5">
						...
						<input
							...
							id="edcity{index}"
							type="text"
							placeholder="Enter Company's city / remote"
						/>
					</div>
					<div class="w-full mr-5">
						<label class="block text-gray-700 font-bold mb-2" for="name"> State </label>
						<input
							...
							id="edstate{index}"
							type="text"
							placeholder="Enter Company's state / India if Remote"
						/>
					</div>
				</div>

				<div class="mb-4 px-3 py-1">
					<label class="block text-gray-700 font-bold mb-2" for="name"> Achievements </label>
					{#each item.achievements as achievement, achievementIndex}
						<input
							...
							type="text"
							placeholder="Enter Your Work {achievementIndex + 1}"
						/>
					{/each}
				</div>
			</div>
	...
	<div class="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
		...
		{#each projects as item, index}
			{#if item.vis}
				<div in:slide={{ duration: 600, axis: 'y' }} out:slide={{ duration: 800, axis: 'y' }}>
					<div class="mb-4 px-3 py-1">
						<label class="block text-gray-700 font-bold mb-2" for="name"> Project Title </label>
						<input
					...
					<div class="mb-4 px-3 py-1 flex flex-row">
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="name"> Project Month </label>
							<select
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="startMonth{index}"
								name="startMonth{index}"
						...
						<div class="w-full mr-5">
							<label class="block text-gray-700 font-bold mb-2" for="name"> Project Year </label>
							<input
								bind:value={item.startYear}
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="startYear{index}"
				...
				<div class="mb-4 px-3 py-1">
					<label class="block text-gray-700 font-bold mb-2" for="name"> Add Skill Used </label>
					...
					<button
						class="bg-gray-900 my-2 rounded text-white py-2 px-4"
			...
			{#if item.vis}
				<div in:slide={{ duration: 600, axis: 'y' }} out:slide={{ duration: 800, axis: 'y' }}>
					<div class="mb-4 px-3 py-1 flex flex-col sm:flex-row">
						<div>
							<label class="block text-gray-700 font-bold mb-2" for="name"> Title </label>
							<input
								bind:value={item.title}
								class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
								id="companyName{index}"
						...
						<div class="w-full">
							...
							<button
								class="bg-gray-900 mt-2 text-white text-sm py-1 px-2 rounded hover:bg-gray-800 focus:outline-none focus:shadow-outline"
								on:click={() => addTechSkill(index)}>Add SKill</button
							>

							<button
								class="bg-gray-900 mt-2 text-white text-sm py-1 px-2 rounded hover:bg-gray-800 focus:outline-none focus:shadow-outline"
								on:click={() => deleteTechSkill(index)}>Delete SKill</button
							>

							<div class="w-full flex flex-row flex-wrap">
								{#each item.skillSet as ele}
									<span
										class="bg-emerald-50 m-1 text-emerald-600 border border-emerald-400 text-xs font-medium mr-2 px-1.5 rounded-full py-1"
										>{ele}</span
									>
								{/each}
							</div>
	...
	<div class="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
		...
		<div class="mb-4 px-3 py-1">
			<div class="w-full">
				<label class="block text-gray-700 font-bold mb-2" for="name"> Select Category </label>
				<select
					class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
					id="startMonth"
					name="startMonth"
		...
		{#each achievementVar.lists as item, index}
			<div class="mb-4 px-3 py-1">
				<input
					...
					id="achievement"
					type="text"
					placeholder="Enter {achievementVar.title}"
				/>
			</div>
		{/each}
