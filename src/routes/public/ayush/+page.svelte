...
<div class="wrapper clearfix">
  <div class="left">
    ...
    <div class="name-hero">
      ...
      <div class="name-text">
        ...
        <h1>Ayush <em>Sharma</em></h1>
        <p>bengaluru,Karnataka,560103</p>
        <p>ayush.sharma954088@gmail.com</p>
        <p>+91 8178795742</p>
  ...
  <div class="right">
    ...
    <div class="inner">
      <section>
        <h1>Employment</h1>
        <p class="mb-2">July 2024 - Present <em>Ecozen Solutions | Software Developer</em></p>
        
        <p>- Developed landing dashboard displaying Ecofrost's battery and product data, enhanced with Tailwind, Next.js, and JavaScript.</p>
        <p>- Integrated Inventory records, scheduling, and billing at Ecozen-Ai using Svelte, Django, and PostgreSQL, improving efficiency by 40%.</p>
        <p>- Integrated Google Maps APIs to display devices real-time locations and implemented marker clustering to highlight high-impact regions.</p>
        <div class="w-full h-[1px] bg-black/20 my-5"></div>
        <p class="mb-2">January 2024 - June 2024 | <em>Intel Corporation | INFOSEC Intern</em></p>
        <p>- Automated certificate renewal process in Vms using Python.</p>
        <p>- Developed FastAPI server for 50% faster data retrieval using RESTAPI in
          IPAM system.</p>
        <p>- Resolved tickets related to Firewall,VPN,Proxy in Lab and Enterprise Network.</p>
        <br>
      ...
      <section>
        <h1>Education</h1>
        <p>December 2020 - May 2024 <br><em>National Institute of Technology, Silchar | CSE</em></p>
        <p>B.Tech</p>
        <p>CGPA 8.59</p>
        <br>
